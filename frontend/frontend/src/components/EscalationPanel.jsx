...
export default function EscalationPanel({
  ...
  const statusConfig = {
    assigned: {
      ...
      border: "#3b82f6",
      icon: "👤",
      text: `Analyst "${analyst}" has been assigned to ${reportTitle}.`,
      color: "#1d4ed8",
    },
    escalated: {
      bg: "#fff1f2",
      border: "#ef4444",
      icon: "🚨",
      text: `${reportTitle} has been escalated for urgent review.`,
      color: "#b91c1c",
    },
    approved: {
      bg: "#f0fdf4",
      border: "#22c55e",
      icon: "✅",
      text: `${reportTitle} has been approved. No further action required.`,
      color: "#15803d",
    },
  };
  ...
  return (
    <div style={styles.wrapper}>
        ...
        <div style={styles.headerLeft}>
          ...
          <div>
            ...
            <p style={styles.subtitle}>
              Report: <strong>{reportTitle}</strong> · ID: {reportId}
            </p>
          </div>
        </div>
        <span
      ...
      <p style={styles.description}>
        ...
        for further investigation, escalate for urgent attention, or approve and
        close the report.
      </p>
      ...
      {status && (
        <div
          style={{
            ...
            borderLeft: `4px solid ${statusConfig[status].border}`,
          }}
        >
          ...
          <p
            style={{ ...styles.resultText, color: statusConfig[status].color }}
          >
      ...
      {confirmAction && (
        <div
          style={{
            ...styles.confirmBox,
            borderLeft: `4px solid ${confirmAction === "escalate" ? "#ef4444" : "#22c55e"}`,
            background: confirmAction === "escalate" ? "#fff1f2" : "#f0fdf4",
          }}
        >
          <p
            style={{
              ...styles.confirmText,
              color: confirmAction === "escalate" ? "#b91c1c" : "#15803d",
            }}
          >
            {confirmAction === "escalate"
              ? `⚠ Are you sure you want to escalate "${reportTitle}"?`
              : `✅ Are you sure you want to approve "${reportTitle}"?`}
          </p>
          <div style={styles.confirmBtns}>
            <button
              ...
              style={{
                ...styles.confirmYes,
                background:
                  confirmAction === "escalate" ? "#ef4444" : "#22c55e",
              }}
            >
      ...
      {showAssignInput && !status && (
        <div style={styles.assignBox}>
          <label style={styles.assignLabel} className="label-required">
            Enter Analyst Name
          </label>
          <input
            type="text"
